...
//                .frame(width: 198.96, height: 198.96, alignment: .center)
            ...
            Circle()
                .fill(LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.8679115176, green: 0.8828440309, blue: 0.904078424, alpha: 1)), Color(#colorLiteral(red: 0.9795069098, green: 0.9844784141, blue: 0.9886956811, alpha: 1)), Color(#colorLiteral(red: 0.9795069098, green: 0.9844784141, blue: 0.9886956811, alpha: 1)), Color(#colorLiteral(red: 0.771204412, green: 0.8212063313, blue: 0.8846092224, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomTrailing))
